...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.has_logged_in'
        db.add_column('ui_userprofile', 'has_logged_in',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.login_date'
        db.add_column('ui_userprofile', 'login_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.has_completed_training'
        db.add_column('ui_userprofile', 'has_completed_training',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.training_completion_date'
        db.add_column('ui_userprofile', 'training_completion_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.has_consented'
        db.add_column('ui_userprofile', 'has_consented',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.consent_date'
        db.add_column('ui_userprofile', 'consent_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.has_logged_in'
        db.delete_column('ui_userprofile', 'has_logged_in')

        # Deleting field 'UserProfile.login_date'
        db.delete_column('ui_userprofile', 'login_date')

        # Deleting field 'UserProfile.has_completed_training'
        db.delete_column('ui_userprofile', 'has_completed_training')

        # Deleting field 'UserProfile.training_completion_date'
        db.delete_column('ui_userprofile', 'training_completion_date')

        # Deleting field 'UserProfile.has_consented'
        db.delete_column('ui_userprofile', 'has_consented')

        # Deleting field 'UserProfile.consent_date'
        db.delete_column('ui_userprofile', 'consent_date')
    ...
    models = {
        ...
        'ui.userprofile': {
            ...
            'consent_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'has_completed_training': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'has_consented': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'has_logged_in': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'training_completion_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
