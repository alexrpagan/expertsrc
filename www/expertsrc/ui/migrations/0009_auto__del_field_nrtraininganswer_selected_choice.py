...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NRTrainingAnswer.selected_choice'
        db.delete_column('ui_nrtraininganswer', 'selected_choice_id')


    def backwards(self, orm):
        # Adding field 'NRTrainingAnswer.selected_choice'
        db.add_column('ui_nrtraininganswer', 'selected_choice',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ui.SchemaMapChoice'], null=True, blank=True),
                      keep_default=False)
