...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ui_application', (
            ...
            ('in_table', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('out_table', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('mq_table', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
        ...
        db.create_table('ui_questiontype', (
            ...
            ('question_class', self.gf('django.db.models.fields.related.OneToOneField')(related_name='+', unique=True, to=orm['contenttypes.ContentType'])),
            ('answer_class', self.gf('django.db.models.fields.related.OneToOneField')(related_name='+', unique=True, to=orm['contenttypes.ContentType'])),
            ('review_class', self.gf('django.db.models.fields.related.OneToOneField')(related_name='+', unique=True, to=orm['contenttypes.ContentType'])),
        ))
        ...
        db.create_table('ui_messages', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('message_id', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('ui', ['Messages'])
    ...
    models = {
        ...
        'ui.questiontype': {
            ...
            'answer_class': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'unique': 'True', 'to': "orm['contenttypes.ContentType']"}),
            'app': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ui.Application']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'long_name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'question_class': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'unique': 'True', 'to': "orm['contenttypes.ContentType']"}),
            'review_class': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'unique': 'True', 'to': "orm['contenttypes.ContentType']"}),
            'short_name': ('django.db.models.fields.CharField', [], {'max_length': '32'})
        },
        'ui.review': {
