...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SchemaMapAnswer.selected_choice'
        db.delete_column('ui_schemamapanswer', 'selected_choice_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SchemaMapAnswer.selected_choice'
        raise RuntimeError("Cannot reverse this migration. 'SchemaMapAnswer.selected_choice' and its values cannot be restored.")
