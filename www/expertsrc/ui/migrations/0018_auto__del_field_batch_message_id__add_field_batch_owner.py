...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Batch.message_id'
        db.delete_column('ui_batch', 'message_id')

        # Adding field 'Batch.owner'
        db.add_column('ui_batch', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Batch.message_id'
        db.add_column('ui_batch', 'message_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Batch.owner'
        db.delete_column('ui_batch', 'owner_id')
