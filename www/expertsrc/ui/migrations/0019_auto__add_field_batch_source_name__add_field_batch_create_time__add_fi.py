...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Batch.source_name'
        db.add_column('ui_batch', 'source_name',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Batch.create_time'
        db.add_column('ui_batch', 'create_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Batch.is_allocated'
        db.add_column('ui_batch', 'is_allocated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Batch.question_type'
        db.add_column('ui_batch', 'question_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['ui.QuestionType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Batch.source_name'
        db.delete_column('ui_batch', 'source_name')

        # Deleting field 'Batch.create_time'
        db.delete_column('ui_batch', 'create_time')

        # Deleting field 'Batch.is_allocated'
        db.delete_column('ui_batch', 'is_allocated')

        # Deleting field 'Batch.question_type'
        db.delete_column('ui_batch', 'question_type_id')
    ...
    models = {
        ...
        'ui.batch': {
            ...
            'question_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ui.QuestionType']"}),
            'source_name': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'})
        },
        'ui.choice': {
