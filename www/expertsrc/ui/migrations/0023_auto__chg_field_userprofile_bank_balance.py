...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.bank_balance'
        db.alter_column('ui_userprofile', 'bank_balance', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'UserProfile.bank_balance'
        db.alter_column('ui_userprofile', 'bank_balance', self.gf('django.db.models.fields.IntegerField')())
