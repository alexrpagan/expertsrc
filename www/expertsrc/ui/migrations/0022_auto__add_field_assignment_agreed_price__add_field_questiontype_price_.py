...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assignment.agreed_price'
        db.add_column('ui_assignment', 'agreed_price',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'QuestionType.price'
        db.add_column('ui_questiontype', 'price',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Batch.budget'
        db.add_column('ui_batch', 'budget',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assignment.agreed_price'
        db.delete_column('ui_assignment', 'agreed_price')

        # Deleting field 'QuestionType.price'
        db.delete_column('ui_questiontype', 'price')

        # Deleting field 'Batch.budget'
        db.delete_column('ui_batch', 'budget')
