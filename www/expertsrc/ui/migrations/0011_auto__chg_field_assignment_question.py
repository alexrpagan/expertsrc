...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Assignment.question'
        db.alter_column('ui_assignment', 'question_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ui.BaseQuestion']))

    def backwards(self, orm):

        # Changing field 'Assignment.question'
        db.alter_column('ui_assignment', 'question_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ui.Question']))
