...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BaseAnswer.end_time'
        db.delete_column('ui_baseanswer', 'end_time')


    def backwards(self, orm):
        # Adding field 'BaseAnswer.end_time'
        db.add_column('ui_baseanswer', 'end_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 7, 3, 0, 0), blank=True),
                      keep_default=False)
