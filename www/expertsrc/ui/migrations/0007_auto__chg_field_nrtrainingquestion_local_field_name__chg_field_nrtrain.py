...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NRTrainingQuestion.local_field_name'
        db.alter_column('ui_nrtrainingquestion', 'local_field_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'NRTrainingQuestion.local_field_id'
        db.alter_column('ui_nrtrainingquestion', 'local_field_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'NRTrainingQuestion.local_field_name'
        db.alter_column('ui_nrtrainingquestion', 'local_field_name', self.gf('django.db.models.fields.CharField')(default='boo', max_length=128))

        # Changing field 'NRTrainingQuestion.local_field_id'
        db.alter_column('ui_nrtrainingquestion', 'local_field_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=-1))
    ...
    models = {
        ...
        'ui.nrtrainingquestion': {
            ...
            'local_field_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'local_field_name': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'})
        },
        'ui.nrtrainingreview': {
