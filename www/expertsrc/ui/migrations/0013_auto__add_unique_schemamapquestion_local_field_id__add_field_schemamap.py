...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'SchemaMapQuestion', fields ['local_field_id']
        db.create_unique('ui_schemamapquestion', ['local_field_id'])

        # Adding field 'SchemaMapChoice.confidence_score'
        db.add_column('ui_schemamapchoice', 'confidence_score',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'SchemaMapAnswer.local_field_id'
        db.add_column('ui_schemamapanswer', 'local_field_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'SchemaMapAnswer.global_attribute_id'
        db.add_column('ui_schemamapanswer', 'global_attribute_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'SchemaMapAnswer.is_match'
        db.add_column('ui_schemamapanswer', 'is_match',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'SchemaMapReview.correct_choice'
        db.delete_column('ui_schemamapreview', 'correct_choice_id')


    def backwards(self, orm):
        # Removing unique constraint on 'SchemaMapQuestion', fields ['local_field_id']
        db.delete_unique('ui_schemamapquestion', ['local_field_id'])

        # Deleting field 'SchemaMapChoice.confidence_score'
        db.delete_column('ui_schemamapchoice', 'confidence_score')

        # Deleting field 'SchemaMapAnswer.local_field_id'
        db.delete_column('ui_schemamapanswer', 'local_field_id')

        # Deleting field 'SchemaMapAnswer.global_attribute_id'
        db.delete_column('ui_schemamapanswer', 'global_attribute_id')

        # Deleting field 'SchemaMapAnswer.is_match'
        db.delete_column('ui_schemamapanswer', 'is_match')


        # User chose to not deal with backwards NULL issues for 'SchemaMapReview.correct_choice'
        raise RuntimeError("Cannot reverse this migration. 'SchemaMapReview.correct_choice' and its values cannot be restored.")
