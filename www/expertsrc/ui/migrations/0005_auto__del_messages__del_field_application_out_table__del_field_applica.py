...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Application.out_table'
        db.delete_column('ui_application', 'out_table')

        # Deleting field 'Application.in_table'
        db.delete_column('ui_application', 'in_table')

        # Deleting field 'Application.mq_table'
        db.delete_column('ui_application', 'mq_table')

        # Adding field 'Application.batch_size'
        db.add_column('ui_application', 'batch_size',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Application.out_table'
        db.add_column('ui_application', 'out_table',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Application.in_table'
        db.add_column('ui_application', 'in_table',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Application.mq_table'
        db.add_column('ui_application', 'mq_table',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Application.batch_size'
        db.delete_column('ui_application', 'batch_size')
