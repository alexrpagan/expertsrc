...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NRTrainingQuestion.correct_choice'
        db.delete_column('ui_nrtrainingquestion', 'correct_choice_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'NRTrainingQuestion.correct_choice'
        raise RuntimeError("Cannot reverse this migration. 'NRTrainingQuestion.correct_choice' and its values cannot be restored.")
