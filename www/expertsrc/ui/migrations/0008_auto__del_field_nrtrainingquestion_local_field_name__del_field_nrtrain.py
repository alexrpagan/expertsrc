...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NRTrainingQuestion.local_field_name'
        db.delete_column('ui_nrtrainingquestion', 'local_field_name')

        # Deleting field 'NRTrainingQuestion.local_field_id'
        db.delete_column('ui_nrtrainingquestion', 'local_field_id')


        # Changing field 'NRTrainingAnswer.selected_choice'
        db.alter_column('ui_nrtraininganswer', 'selected_choice_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ui.SchemaMapChoice'], null=True))

    def backwards(self, orm):
        # Adding field 'NRTrainingQuestion.local_field_name'
        db.add_column('ui_nrtrainingquestion', 'local_field_name',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NRTrainingQuestion.local_field_id'
        db.add_column('ui_nrtrainingquestion', 'local_field_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'NRTrainingAnswer.selected_choice'
        raise RuntimeError("Cannot reverse this migration. 'NRTrainingAnswer.selected_choice' and its values cannot be restored.")
    ...
    models = {
        ...
        'ui.nrtraininganswer': {
            ...
            'selected_choice': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ui.SchemaMapChoice']", 'null': 'True', 'blank': 'True'})
        },
