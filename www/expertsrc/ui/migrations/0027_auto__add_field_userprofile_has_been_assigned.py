...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.has_been_assigned'
        db.add_column('ui_userprofile', 'has_been_assigned',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.has_been_assigned'
        db.delete_column('ui_userprofile', 'has_been_assigned')
