...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'QuestionBatch'
        db.delete_table('ui_questionbatch')
        ...
        # Adding field 'SchemaMapQuestion.batch'
        db.add_column('ui_schemamapquestion', 'batch',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['ui.Batch']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'QuestionBatch'
        db.create_table('ui_questionbatch', (
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ui.BaseQuestion'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('message_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('ui', ['QuestionBatch'])
