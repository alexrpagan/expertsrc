$(function() {
    ...
    // initialize sliders for price and confidence bounds
    ...
    // use this to fill allocation details popover
    var get_modal_html = function (data) {
        id = data.id;
    ...
    var fill_content = function (id, data) {
    ...
    var truncate_float = function(num, places){
    ...
    // which allocation strategy are we using?
    var select_minprice = function() {
    ...
    // show/hide the generate suggestions
    var toggle_selections = function(obj) {
